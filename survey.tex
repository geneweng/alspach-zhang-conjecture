...
\item (Weighted cut code.)  Can one choose a member of the symmetric matrix family $B_c$ in Proposition~\ref{prop:quotient-form} whose radical supplies directions solving the transvection syndrome \eqref{eq:syndrome-criterion}?  Making $B_c$ have small rank alone is insufficient, as the dimension-six experiment shows.  The consecutive monochromatic cycles of Proposition~\ref{prop:mono-cycle} and the order-five criterion of Proposition~\ref{prop:order-five-interlacement} give concrete sufficient patterns for individual directions; the simultaneous obstruction above describes when they share a choice of lifts.  For $s=5$, can the lift bits that preserve $B_c$ be used to control the syndrome?
\end{enumerate}
